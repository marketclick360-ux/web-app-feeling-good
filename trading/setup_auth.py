...
print(f"  {auth_url}")
print()
print("  2. Log in with your regular Schwab brokerage username & password")
print("     then click Allow.")
print()
print("  3. Browser will show 'This site can't be reached' — that's OK.")
print()
...
if not code:
    raise SystemExit("\n  No code found — please try again from step 1.\n")
...
try:
    ...
    raise SystemExit(f"\n  Failed (HTTP {e.code}). Double-check your Client ID and Secret in .env\n")
...
print(f"\n  Done! Token saved.")
print("  Now run:  python3 backtest.py")
print()
